# Set Test Name in Python UnitTest with Selenium on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can set a custom test name for each automation test so runs are clearly labelled and easy to identify in your dashboard. This sample shows how to configure the test name capability in Python UnitTest on the TestMu AI cloud.
...
## Setting the Test Name Capability

To set the test name for your automation test, add the `name` attribute as a capability in the desired capabilities. For example:
